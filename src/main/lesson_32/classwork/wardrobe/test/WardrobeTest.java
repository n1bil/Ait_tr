package main.lesson_32.classwork.wardrobe.test;

import main.lesson_32.classwork.wardrobe.model.Wardrobe;
...
public class WardrobeTest {
    ...
    @BeforeEach
    void setUp() {
        wardrobes = getWardroves();
    }

    private Wardrobe[] getWardroves() {
