package main.lesson_52_HashSet_TreeSet.homework.citizens.test;

import main.lesson_52_HashSet_TreeSet.homework.citizens.dao.Citizens;
import main.lesson_52_HashSet_TreeSet.homework.citizens.dao.CitizensSetImpl;
...
class CitizensTest {
    ...
    void testCitizensImplListOfPeople() {
        ...
        CitizensSetImpl citizens = new CitizensSetImpl(personList);
