package main.lesson_35_JavaTimeAPI.classwork.time;
...
public class TimeAppl {
    public static void main(String[] args) {
        ...
        System.out.println(newDate);
        System.out.println(localDateTime.plus(10, ChronoUnit.HALF_DAYS));
        ...
        System.out.println(gagarin.format(df));
        df = DateTimeFormatter.ofPattern("dd/MMMM/yyyy", Locale.forLanguageTag("fr"));
        System.out.println(gagarin.format(df));
