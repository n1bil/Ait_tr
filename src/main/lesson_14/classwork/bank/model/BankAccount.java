package main.lesson_14.classwork.bank.model;
...
public class BankAccount {
    ...
    public void display() {
        System.out.println("Account: " + account + ", owner: " + owner + ", bank: " + bank + ", balance: " + balance);
    }

    public void display(String greeting) {
        System.out.println("Account: " + account + greeting + owner + ", bank: " + bank + ", balance: " + balance);
    }
